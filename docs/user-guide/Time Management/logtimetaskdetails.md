...
- Select either **Duration** (drag to set hours) or **Time Range** (enter start and end time)
- Confirm the **Project** and **Task**
- Choose whether the time is **Billable** or **Non-Billable**

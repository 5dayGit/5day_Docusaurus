...
- Click the **tick icon** to instantly submit that time entry for approval.

Note: You can identify unsubmitted time entries by the **"To Submit"** status.

#### **2. Submit from Project Timesheet (Day, Week, Month, List)**

...
The Account Owner has full rights assigned by default across both:
...
## **Global Permissions for Account Owner**
...
✅ The Account Owner can fully configure and manage all administrative settings without any limitations.

## **Feature Permissions for Account Owner**

|**Feature**|**View Access**|**Add**|**Edit Access**|**Delete Access**|**Other Actions**|
| :-: | :-: | :-: | :-: | :-: | :-: |
...
|Discussion|View|✔️|||Not Applicable|
|File|View|✔️|||Not Applicable|

...
<img width="3690" height="2612" alt="image" src="https://github.com/user-attachments/assets/a0d41667-5c2a-4190-b8ca-b2ba41bb800f" />
...
<img width="3868" height="2340" alt="image" src="https://github.com/user-attachments/assets/163a9a6c-2548-491a-9bc9-550524ccf2ea" />
...
1. Fill in the required fields:
   ...
   1. **Where** – (Auto-filled based on where you clicked, but editable)
   1. **Description** – *(Optional)* A short summary
   1. **Duration** – Start Date and Due Date
1. Click **Add** to create your project

<img width="3868" height="2340" alt="image" src="https://github.com/user-attachments/assets/77ff9f73-4079-46a2-8d3f-bfb54ef72774" />
...
- **Project Menu**: Next to an existing project, click the **three-dot menu (⋮)** and select **Add Project**. This will place the new project in the same space as the existing one.
- **Quick Add Button:** From the top left navigation bar, click on the **Quick Add (+)** icon — represented by a plus sign inside a circle. Once the quick add menu opens, click on **Project** to start creating a new project. 
- **Add (+) Button:** A cross spaces and workspaces, you’ll find an **Add (+)** button.   Click it, and from the dropdown menu, select **Project** to start project creation.
...
1. Choose between:
   1. **Default Templates** – Templates provided by 5day.io for common use cases.
   1. **Custom Templates** – Templates previously saved by your team.
1. Click on a template to preview and select it.
1. Fill in the rest of the details:
   1. **Project Name**
   1. **Where** – Workspace or space (auto-filled, but editable)
   1. **Description** *(optional)*
   1. **Start Date & Due Date**
1. Click **Add** to create the project.

 <img width="3868" height="2340" alt="image" src="https://github.com/user-attachments/assets/a9276d10-cfb6-4bb8-b89d-3022a2ca20f0" />

...
⠀✅ Project creation access is controlled through role-based permissions in **Security & Permissions**. 
 
## Project Attributes 
...
* **Where** – The workspace or space under which the project will be created 
* **Description** – (Optional) A brief explanation of the project 
* **Duration** – Start Date and Due Date to set a timeline 

⠀ 
### After Project Creation (in Project Settings): 
You can further configure: 
* **Priority** – Choose from predefined levels (e.g., High, Medium, Low) 
* **Budget Type** – Select whether the project is billable or non-billable 
* **Prefix** – A short code added to all tasks ID within the project (e.g., MKTG-101) 
* **Progress** – Track % completion of the project 
* **Owner** – Assign responsibility to a specific person 
* **Description** – Update or expand the project summary 
* **Client** – Tag the project to a specific client. (This option is available only if the Client feature is enabled in Project Settings.) 
* **Custom Fields** – Add fields like budget, department, or tags as per your needs 
